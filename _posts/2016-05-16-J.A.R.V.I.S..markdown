...
Almost a week ago, I attempted to create [my own version](https://github.com/nihal111/J.A.R.V.I.S) of Iron Man's J.A.R.V.I.S. -- a personal assistant that can perform tasks and hold chatbot-like conversations. After some research, I found [AIML](http://www.alicebot.org/aiml.html) and its [Python interpreter](https://pypi.python.org/pypi/PyAIML). I also discovered ways to convert text to speech and speech to text using Python libraries like [pyttsx](https://pypi.python.org/pypi/pyttsx) and [SpeechRecognition](https://pypi.python.org/pypi/SpeechRecognition/3.4.3). Before long, I had a J.A.R.V.I.S. that understood some of what I said and performed a few fun actions.
