...
1. Download [this](https://slack-files.com/T03G8SB1X-F6GSEKGLU-87475679ce) Omega.
2. Extract the Omega.
3. Move the save folder called "Lost" inside `omega788/saves` to the save directory-
...
{: .center}
![antrumSabre]({{ site.baseurl }}/img/antrumSabre.png "antrumSabre"){:style="max-height: 100px;"}
...
{: .center}
![obsidianTorch]({{ site.baseurl }}/img/obsidianTorch.png "obsidianTorch"){:style="max-height: 100px;"}
...
{: .center}
![pyramidAngel]({{ site.baseurl }}/img/pyramidAngel.jpg "pyramidAngel"){:style="max-width: 400px; max-height: 400px;"}
![stonehengeAngel]({{ site.baseurl }}/img/stonehengeAngel.jpg "stonehengeAngel"){:style="max-width: 400px; max-height: 400px;"}
![templeAngel]({{ site.baseurl }}/img/templeAngel.jpg "templeAngel"){:style="max-width: 400px; max-height: 400px;"}
...
I'll be making a wrap up post soon to cover all my contributions over the summer with a few stats. Plus, there might be a teaser video for the Lost module.