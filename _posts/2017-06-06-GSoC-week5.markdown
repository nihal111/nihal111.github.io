...
Last week involved a lot of discussions, and the plan for the next two months is now much clearer. Here's a quick fun video that should explain the title of this blog post.
...
The first item I decided to work on was the Swinging Blade. The setup consists of a huge blade that swings to and fro from one edge of the room to the other. It serves as an obstacle -- coming in contact with the blade deals damage to the player.
