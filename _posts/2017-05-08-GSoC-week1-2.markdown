...
The start to GSoC has been smooth. As I write this wrap-up post for weeks one and two, my work has already crossed the week 3 mark according to the proposal. Ahead of schedule -- the best kind of schedule.
...
This post ran longer than expected. The next one will cover details of the deer that have been implemented and maybe some new creatures. Most deer at this point are just placeholders for other animals whose models aren't ready yet. Huge thanks to [flo](http://forum.terasology.org/members/florian.1335/) for all his help -- the entire event-driven behavior system idea was born out of a discussion with him, and he's been invaluable in getting PRs reviewed and merged.

In other news, I was away for 3 days (10th to 12th May) for the [Microsoft code.fun.do SHOWCASE event](https://www.acadaccelerator.com/Home/CFDShowCase) in Hyderabad. Fun trip with sponsored flights and hotel stay. Time to catch up on GSoC now.